...
public class JettyDeployerTest
    extends TestCase
{
    ...
    protected class DeployRequestImpl
        ...
        throws Exception
    {
        ...
        remoteServerType =
            new org.apache.maven.mercury.transport.api.Server( "test", new URL( _HOST_FRAGMENT + _port ) );
    ...
    public void testUploadOKWithChecksums()
        throws Exception
    {
    ...
    public void testUploadOKWithExemptChecksums()
        throws Exception
    {
        HashSet<Binding> bindings = new HashSet<Binding>();
        DeployRequestImpl request = new DeployRequestImpl();
        ...
        Binding binding5 = new Binding( new URL( _HOST_FRAGMENT + _port + __PATH_FRAGMENT + "file5.jpg" ), _file5 );
        Binding binding6 =
            new Binding( new URL( _HOST_FRAGMENT + _port + __PATH_FRAGMENT + "file6.gif" ), _file6, true ); // exempt
    ...
    /*
     * This test duplicates the one above unless we allow for checksum files to be pre-existing public void
     * testUploadOKMissingChecksum () throws Exception { HashSet<Binding> bindings = new HashSet<Binding>();
     * DeployRequestImpl request = new DeployRequestImpl(); _file0 = new File(_baseDir, "file0.txt"); _file1 = new
     * File(_baseDir, "file1.txt"); _file2 = new File(_baseDir, "file2.txt"); _file3 = new File(_baseDir, "file3.jar");
     * _file4 = new File(_baseDir, "file4.so"); _file5 = new File(_baseDir, "file5.jpg");
     * _binding0.setRemoteResource(_HOST_FRAGMENT+_port+__PATH_FRAGMENT+"file0.txt"); _binding0.setLocalFile(_file0);
     * bindings.add(_binding0); //TODO Test Lenient
     * _binding1.setRemoteResource(_HOST_FRAGMENT+_port+__PATH_FRAGMENT+"file1.txt"); //has no sha file
     * _binding1.setLocalFile(_file1); //_binding1.setLenientChecksum(true); bindings.add(_binding1);
     * _binding3.setRemoteResource(_HOST_FRAGMENT+_port+__PATH_FRAGMENT+"file3.jar"); _binding3.setLocalFile(_file3);
     * bindings.add(_binding3); _binding4.setRemoteResource(_HOST_FRAGMENT+_port+__PATH_FRAGMENT+"file4.so");
     * _binding4.setLocalFile(_file4); bindings.add(_binding4);
     * _binding5.setRemoteResource(_HOST_FRAGMENT+_port+__PATH_FRAGMENT+"file5.jpg"); _binding5.setLocalFile(_file5);
     * bindings.add(_binding5); request.setBindings(bindings); DeployResponse response = _deployer.deploy(request);
     * //for (MercuryException t:response.getExceptions()) // t.printStackTrace(); assertEquals(10,
     * _putServer.getPutDir().list().length); assertEquals(0, response.getExceptions().size()); File f0 = new
     * File(_putServer.getPutDir(), "file0.txt"); File f0cs = new File (_putServer.getPutDir(), "file0.txt.sha1");
     * assertTrue (f0.exists()); assertTrue (f0cs.exists()); File f1 = new File(_putServer.getPutDir(), "file1.txt");
     * File f1cs = new File(_putServer.getPutDir(), "file1.txt.sha1"); assertTrue(f1.exists());
     * assertTrue(f1cs.exists()); File f3 = new File(_putServer.getPutDir(), "file3.jar"); File f3cs = new File
     * (_putServer.getPutDir(), "file3.jar.sha1"); assertTrue(f3.exists()); assertTrue(f3cs.exists()); File f4 = new
     * File(_putServer.getPutDir(), "file4.so"); File f4cs = new File (_putServer.getPutDir(), "file4.so.sha1");
     * assertTrue (f4.exists()); assertTrue (f4cs.exists()); File f5 = new File(_putServer.getPutDir(), "file5.jpg");
     * File f5cs = new File (_putServer.getPutDir(), "file5.jpg.sha1"); assertTrue (f5.exists()); assertTrue
     * (f5cs.exists()); }
     */
    ...
    public void testUploadFailFast()
        throws Exception
    {
        factories.add( new SHA1VerifierFactory( false, true ) ); // !lenient, sufficient
        remoteServerType.setWriterStreamVerifierFactories( factories );
    ...
    public void testMemoryDeployment()
        throws Exception
    {
        factories.add( new SHA1VerifierFactory( false, true ) ); // !lenient, sufficient
        remoteServerType.setWriterStreamVerifierFactories( factories );
